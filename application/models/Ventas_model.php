...
class Ventas_model extends CI_Model {
	...
	public function getVentas(){
		...
		$this->db->from("requisiciones v");
		$this->db->join("umilitar c","v.cliente_id = c.id");
	...
	public function getDetalle($id){
		...
		$this->db->from("detalle_requisiciones dt");
	...
	public function save($data){
		return $this->db->insert("requisiciones",$data);
	}
	...
	public function save_detalle($data){
		$this->db->insert("detalle_requisiciones",$data);
	}
