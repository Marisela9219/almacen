                                ...
                                <?php if(!empty($productos)):?>
                                    <?php foreach($productos as $producto):?>
                                        <tr>
                                            ...
                                            <td><?php echo $producto->fecha_vence;?></td>
                                            <td><?php echo $producto->proveedor_id;?></td>
                                            <td><?php echo $producto->precio;?></td>
                                            <td><?php echo $producto->stock;?></td>
                                            <td><?php echo $producto->almacen;?></td>
                                            <?php $dataproducto = $producto->id."*".$producto->codigo."*".$producto->nombre."*".$producto->descripcion."*".$producto->precio."*".$producto->stock."*".$producto->almacen;?>
                                            <td>
                                                <div class="btn-group">
