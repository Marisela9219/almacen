                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="<?php echo base_url();?>mantenimiento/almacenes"><i class="fa fa-circle-o"></i> Almacenes</a></li>
                            <li><a href="<?php echo base_url();?>mantenimiento/umilitar"><i class="fa fa-circle-o"></i> Unidades Militares</a></li>
